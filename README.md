...
I'm going deep into AI Engineering — not just API wrappers, but real engineering:

- 🔍 **RAG Pipelines** — Vector DBs, embeddings, semantic search
- 🤖 **AI Agents** — Tool-calling, multi-agent orchestration, LangGraph, CrewAI
- 🔗 **MCP Servers** — Model Context Protocol integrations and automations
- 🧪 **LLM Fine-tuning** — Custom model training (done it with OpenAI for Chronic AI)
- ⚡ **AI Automations** — End-to-end intelligent workflow systems
...
`Banking` · `Healthcare` · `Transportation` · `Web3 / DeFi` · `AI / Generative AI` · `Music` · `Automotive` · `Therapy` · `Blockchain Infrastructure`

---

<div align="center">

*Open to remote opportunities in AI Engineering & Solutions Architecture*

**Let's build something great → yaseensaleem901@gmail.com**
